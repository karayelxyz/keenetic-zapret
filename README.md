...
<br>
<br>
NFQWS_OPT_DESYNC="--dpi-desync=fake --dpi-desync-ttl=2"<br>
NFQWS_OPT_DESYNC_HTTP=""<br>
NFQWS_OPT_DESYNC_HTTPS=""<br>
NFQWS_OPT_DESYNC_HTTP6=""<br>
NFQWS_OPT_DESYNC_HTTPS6="--dpi-desync=fake --dpi-desync-ttl=2 --dpi-desync-fake-tls=0x00000000"<br>
NFQWS_OPT_DESYNC_QUIC="--dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-ttl=2"<br>
NFQWS_OPT_DESYNC_QUIC6="--dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-ttl=2"
</details>
